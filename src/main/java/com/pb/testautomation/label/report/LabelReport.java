...
public class LabelReport implements IReport {
	...
	public static final String MASTER_TEST_CORRUPT = "Master/test label might be corrupt.";
	...
	public String generateReport() {
		...
		labelReportBuilder.append("Comparing test label "+ labelName + " with corresponding master label.");
		if(pageReports.isEmpty()) {
